  ...
  return (
    <div className="dash-page">
      <header className="dash-header">
        <h1>Integrations</h1>
        <p>
          Connect external services so Viin can sync events and deliver smarter reminders.
        </p>
      </header>
      ...
      {loading ? (
        ...
        <section className="dash-card integration-panel">
          ...
          {status?.connected && (
            <form onSubmit={handleSaveSettings} className="dash-form">
              <label>
